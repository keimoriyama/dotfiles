...
*** org-roam
#+begin_src elisp
(autoload-if-found '(org-mode) "org-roam" nil t)
...
(with-eval-after-load 'org-super-agenda
  ...
  (setq org-super-agenda-groups
         '((:name "Log"
            :log t)
           (:name "PAST DEADLINESS"
                  :deadline past)
           (:name "Doing Task"  ; Optionally specify section name
                  :time-grid t  ; Items that appear on the time grid
                  :todo "DOING")
           (:name "Scheduled TODO Items"
                  :todo "TODO"
                  :children t)
            (:name "Today"
                :scheduled today)
