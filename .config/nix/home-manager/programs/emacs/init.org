...
(with-eval-after-load 'org
  ...
  (setopt org-deadline-warning-day  30)
...
(with-eval-after-load 'org-agenda
  ...
  (setopt org-agenda-start-on-weekday 3)
  ...
  (setopt org-agenda-files  '("~/Documents/org-mode/projects")))
...
(with-eval-after-load 'lsp-ui
  ...
  (global-set-key "C-c l" #'lsp-ui/body)
  )
#+end_src
*** flycheck
#+begin_src elisp
