...
(leaf olivetti
  :ensure nil
  :init (olivetti-mode t))
  ;:global-minor-mode olivetti-mode)
#+end_src
...
(leaf lsp-bridge
  :ensure nil
;  :global-minor-mode lsp-bridge-mode
  :init (global-lsp-bridge-mode)
  :custom ((lsp-bridge-python-lsp-server . '("pyright", "ruff"))
           (acm-enable-capf . t)
           (lsp-bridge-enable-org-babel . t))
  :pretty-hydra
  ((:title "LSP" :color blue :quit-key "q" :foreign-keys warn :separator "╌")
   ("peek"
    (("d" lsp-bridge-find-def "definitions")
     ("r" lsp-bridge-find-references "references")
     ("b" lsp-bridge-find-def-return "go back to previous location"))
    "code action"
    (("n" lsp-bridge-rename "rename")
