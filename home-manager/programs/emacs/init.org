...
(mapc #'create-file
      (list org-memo-file org-misc-file org-diary-file org-weekly-log-file))
...
(pretty-hydra-define eglot
  ...
  ("peek"
   ...
   "search"
   (("e" consult-eglot-symbols "symbols")
...
(defun uv-check-package-existance()
  (interactive))

(defun uv-project-existence(package-name)
  "evaluate if the package-name exists in the current project"
  )
