...
(with-eval-after-load 'org
  (setq org-startup-folded 'content
        ...
        '(("Effort_ALL" . "0 0:30 1:00 1:30 2:00 2:30")))
...
(with-eval-after-load 'org
  (setq org-agenda-custom-commands 
          ...
          ("v" "List of TODOs"
           (
            ...
            (alltodo "" ((org-super-agenda-groups
                            '((:name "実行中..." :todo "DOING")
                              (:discard (:anything t))))))
            (alltodo "" ((org-agenda-overriding-header "締切リスト")
                         (org-super-agenda-groups
                          '((:name "スケジュール" :auto-planning t)
                            (:name "" :auto-category t))))))))
        ...
        org-agenda-files (list org-prj-dir)
