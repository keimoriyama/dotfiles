...
(defun kei/eglot-completion-at-point ()
...
(defun kei/eglot-format-buffer-if-supported ()
...
(with-eval-after-load 'eglot
  ...
  (add-hook 'eglot-managed-mode-hook
            (lambda ()
              (kei/eglot-completion-at-point)
              (add-hook 'before-save-hook
                        #'kei/eglot-format-buffer-if-supported nil t)))
...
(with-eval-after-load 'eglot
  (setq eglot-server-programs
        (cl-remove-if #'kei/eglot-python-server-program-p
  ...
  (add-to-list 'eglot-server-programs
               '((rust-ts-mode rust-mode) .
                 ("rustup" "run" "stable" "rust-analyzer"
                  :initializationOptions (:cargo (:allFeatures t
