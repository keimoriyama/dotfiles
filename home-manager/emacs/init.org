...
** auto save files
ref: http://0xcc.net/misc/auto-save/
#+begin_src emacs-lisp
...
Reference: [[https://sophiebos.io/posts/prettifying-emacs-org-mode/][Prettifying Emacs Org Mode]]
#+begin_src emacs-lisp
...
(add-to-list 'eglot-server-programs
              '(python-mode . ("rass" "--" "ty" "server" "--" "ruff" "server")))
#+end_src
**** nix
#+begin_src emacs-lisp
